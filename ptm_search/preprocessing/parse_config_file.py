...
# ---------------------------------------------------/ --- /------------------------------------------------------------
def make_config_files(list_of_MOD_RES, config, variant_fo_search_):
...
def parse_config_file(list_of_MOD_RES_, config, variant_fo_search):
    text4 = ' Создание конфигурационных файлов для поиска PTM '
    number4 = int(round((200 - len(text4)) / 2, 0))
    print(f'{text4:.^{number4}}')
    make_config_files(list_of_MOD_RES_, config, variant_fo_search)
